...
def draw_misc():
    ...
    if not game_start:
        ...
        text = font.render('Welcome to pacman, Press start or space to begin!', True, 'red')
        screen.blit(text, (100, 300))
    if game_over:
        pygame.draw.rect(screen, 'white', [50, 200, 800, 300], 0, 10)
        pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
        text = font.render('Game over! Press Start button to restart!', True, 'red')
        screen.blit(text, (100, 300))
    if game_won:
        pygame.draw.rect(screen, 'white', [50, 200, 800, 300], 0, 10)
        pygame.draw.rect(screen, 'dark gray', [70, 220, 760, 260], 0, 10)
        text = font.render('Victory! Press Start button to restart!', True, 'green')
        screen.blit(text, (100, 300))
...
while run:
    ...
    if powerup and (player_circle.colliderect(blinky.rect) and eaten_ghost[0] and not blinky.dead) or \
            ...
            (player_circle.colliderect(clyde.rect) and eaten_ghost[3] and not clyde.dead):
        if lives > 0:
            powerup = False
            power_counter = 0
            lives -= 1
